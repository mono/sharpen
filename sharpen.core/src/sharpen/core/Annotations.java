...
public class Annotations {
	...
	static final String SHARPEN_RENAME = "@sharpen.rename";
	...
	static final String SHARPEN_PROPERTY = "@sharpen.property";
	
	static final String SHARPEN_INDEXER = "@sharpen.indexer";
